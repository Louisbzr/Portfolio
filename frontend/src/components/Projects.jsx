...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-28 bg-[#0d0d0d] relative">
      ...
      <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-3 border-b border-[#1e1e1e] bg-[#111]">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Badge
                    variant="outline"
                    className="font-mono text-xs border-[#28c840] text-[#28c840] bg-transparent px-2 py-0"
                  >
                    {project.status}
                  </Badge>
                </div>
              ...
              <div className="p-8">
                <div className="grid md:grid-cols-3 gap-8">
                  ...
                  <div className="md:col-span-2 space-y-5">
                    ...
                    <p className="text-[#888] leading-relaxed text-sm ml-7">
        ...
        <div className="mt-12 text-center">
          <p className="font-mono text-[#333] text-sm">
            &gt; Plus de projets sur{" "}
            <a
              href="https://github.com/louis-dev"
              target="_blank"
              rel="noreferrer"
